...
func TestLooksLikeEscapedControl(t *testing.T) {
	assert.True(t, util.LooksLikeEscapedControl("\\u0000 -- NULL"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0001 -- START OF HEADING"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0002 -- START OF TEXT"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0003 -- END OF TEXT"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0004 -- END OF TRANSMISSION"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0005 -- ENQUIRY"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0006 -- ACKNOWLEDGE"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0007 -- BELL"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0008 -- BACKSPACE"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0009 -- CHARACTER TABULATION"))
	assert.True(t, util.LooksLikeEscapedControl("\\u000A -- LINE FEED (LF)"))
	assert.True(t, util.LooksLikeEscapedControl("\\u000B -- LINE TABULATION"))
	assert.True(t, util.LooksLikeEscapedControl("\\u000C -- FORM FEED (FF)"))
	assert.True(t, util.LooksLikeEscapedControl("\\u000D -- CARRIAGE RETURN (CR)"))
	assert.True(t, util.LooksLikeEscapedControl("\\u000E -- SHIFT OUT"))
	assert.True(t, util.LooksLikeEscapedControl("\\u000F -- SHIFT IN"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0010 -- DATA LINK ESCAPE"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0011 -- DEVICE CONTROL ONE"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0012 -- DEVICE CONTROL TWO"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0013 -- DEVICE CONTROL THREE"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0014 -- DEVICE CONTROL FOUR"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0015 -- NEGATIVE ACKNOWLEDGE"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0016 -- SYNCHRONOUS IDLE"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0017 -- END OF TRANSMISSION BLOCK"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0018 -- CANCEL"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0019 -- END OF MEDIUM"))
	assert.True(t, util.LooksLikeEscapedControl("\\u001A -- SUBSTITUTE"))
	assert.True(t, util.LooksLikeEscapedControl("\\u001B -- ESCAPE"))
	assert.True(t, util.LooksLikeEscapedControl("\\u001C -- INFORMATION SEPARATOR FOUR"))
	assert.True(t, util.LooksLikeEscapedControl("\\u001D -- INFORMATION SEPARATOR THREE"))
	assert.True(t, util.LooksLikeEscapedControl("\\u001E -- INFORMATION SEPARATOR TWO"))
	assert.True(t, util.LooksLikeEscapedControl("\\u001F -- INFORMATION SEPARATOR ONE"))
	assert.True(t, util.LooksLikeEscapedControl("\\u007F -- DELETE"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0080 -- <control>"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0081 -- <control>"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0082 -- BREAK PERMITTED HERE"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0083 -- NO BREAK HERE"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0084 -- <control>"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0085 -- NEXT LINE (NEL)"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0086 -- START OF SELECTED AREA"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0087 -- END OF SELECTED AREA"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0088 -- CHARACTER TABULATION SET"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0089 -- CHARACTER TABULATION WITH JUSTIFICATION"))
	assert.True(t, util.LooksLikeEscapedControl("\\u008A -- LINE TABULATION SET"))
	assert.True(t, util.LooksLikeEscapedControl("\\u008B -- PARTIAL LINE FORWARD"))
	assert.True(t, util.LooksLikeEscapedControl("\\u008C -- PARTIAL LINE BACKWARD"))
	assert.True(t, util.LooksLikeEscapedControl("\\u008D -- REVERSE LINE FEED"))
	assert.True(t, util.LooksLikeEscapedControl("\\u008E -- SINGLE SHIFT TWO"))
	assert.True(t, util.LooksLikeEscapedControl("\\u008F -- SINGLE SHIFT THREE"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0090 -- DEVICE CONTROL STRING"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0091 -- PRIVATE USE ONE"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0092 -- PRIVATE USE TWO"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0093 -- SET TRANSMIT STATE"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0094 -- CANCEL CHARACTER"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0095 -- MESSAGE WAITING"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0096 -- START OF GUARDED AREA"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0097 -- END OF GUARDED AREA"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0098 -- START OF STRING"))
	assert.True(t, util.LooksLikeEscapedControl("\\u0099 -- <control>"))
	assert.True(t, util.LooksLikeEscapedControl("\\u009A -- SINGLE CHARACTER INTRODUCER"))
	assert.True(t, util.LooksLikeEscapedControl("\\u009B -- CONTROL SEQUENCE INTRODUCER"))
	assert.True(t, util.LooksLikeEscapedControl("\\u009C -- STRING TERMINATOR"))
	assert.True(t, util.LooksLikeEscapedControl("\\u009D -- OPERATING SYSTEM COMMAND"))
	assert.True(t, util.LooksLikeEscapedControl("\\u009E -- PRIVACY MESSAGE"))
	assert.True(t, util.LooksLikeEscapedControl("\\u009F -- APPLICATION PROGRAM COMMAND"))
	assert.True(t, util.LooksLikeEscapedControl("data/datastream\\u007f.txt"))

	assert.False(t, util.LooksLikeEscapedControl("./this/is/a/valid/file/name.txt"))
}
