...
func TestNSQStatsData(t *testing.T) {
	...
	require.Equal(t, 3, len(stats.Topics))
	assert.Equal(t, "record_channel", stats.Topics[1].Channels[0].ChannelName)
}
